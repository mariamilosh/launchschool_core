...
# Private means that a method cannot be called outside of its class, which
#   is what is happening in #==
# Protected is similar to private but allows a method to be called by other
#   classes than just its own
